<template>
  <div class="demo-test-area--wrapper" :style="{color: textColor}">
    <div class="demo-test-area--title">
      <div class="demo-test-area--title-main" :style="{color: linkColor}">digital-chat demo</div>
      <div class="demo-test-area--title-sub">by <a :style="{color: linkColor}" href="https://matteo.merola.co">reincedaniel</a></div>
    </div>
    ...
    <p class="demo-test-area--info">
      <a :style="{color: linkColor}" href="https://github.com/reincedaniel/digital-chat">digital-chat</a> is a chat window that allows you to build and add custom live chat to your sites. It includes only the vue chat widget. There is no backend, and no communication system baked in.
      <br />
      ...
      <br />
      <br />
      For instructions on how to use it click <a :style="{color: linkColor}" href="https://github.com/reincedaniel/digital-chat">here</a>.
      <br />
      <br />
    </p>
  </div>
